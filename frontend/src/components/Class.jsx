...
export default function Class() {
  ...
  useEffect(() => {
    ...
    // Removed AOS.refreshHard() cleanup to fix error on unmount/navigation
  ...
  return (
    <div id="class" className="class-section">
      <div className="class-container">
        <h1 className="class-text" data-aos="fade-down">
          Classes
        </h1>
        <div className="class-header" data-aos="fade-up">
